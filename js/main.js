(function () {
  ...
  var counterWayPoint = function () {
    // Waypoints may be removed for a slimmer site. If waypoint plugin is
    // available, enable counter animation, otherwise skip.
  ...
  var contentWayPoint = function () {
    // If waypoints isn't present, skip animation wiring
    if (!$.fn.waypoint) return;
    var i = 0;
  ...
  var navigationSection = function () {
    // Navigation highlighting uses waypoints; only wire if plugin exists.
    if (!$.fn.waypoint) return;
